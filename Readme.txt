...
And for every deposit, witdraw and check balance we need to give account number at first.
so, we can just choose the option 6 to view  the account details and copy paste the acc number it when needed.
